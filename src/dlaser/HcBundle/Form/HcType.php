...
class HcType extends AbstractType
{
	public function buildForm(FormBuilder $builder, array $options)
	{
		...
		->add('rev_cardiovascular', 'textarea',array('label' => 'Revisión Sistema Cardiovascular', 'required' => false))
		->add('exa_fisico',			'textarea',array('label' => 'Examen Físico Cardiovascular', 'required' => false))
